...
from DeblurGANv2.models.mobilenet_v2 import MobileNetV2
...
class FPN(nn.Module):
    ...
    def __init__(self, norm_layer, num_filters=128, pretrained=True):
        ...
        if pretrained:
            ...
            state_dict = torch.load('DeblurGANv2/mobilenetv2.pth.tar', map_location=torch.device('cuda:0')) # add map_location='cpu' if no gpu
