...
class PyramidPatchMatcher:
    def __init__(self, image_height, image_width, channel, minimum_patch_size, threads_per_block=8, num_iter=5,
                 gpu_id=0, guide_weight=10.0, use_mean_target_style=False, initialize="identity"):
    ...
    with gr.Blocks(analytics_enabled=False) as ui_component:
        ...
        with gr.Row():
            with gr.Column():
                ...
                minimum_patch_size = gr.Slider(label="Minimum patch size (odd number)", value=5, minimum=5, maximum=99,
                                               step=2)
