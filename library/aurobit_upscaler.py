...
class UpscalerESRGAN():
    ...
    def do_upscale(self, img, selected_model):
        try:
            ...
            return img
        print(f'Upscale using {selected_model}')
        model.to('cuda')
    ...
    def load_model(self, path: str):
        ...
        if "params_ema" in state_dict:
            ...
            model = SRVGGNetCompact(num_in_ch=3, num_out_ch=3, num_feat=64, num_conv=num_conv, upscale=4,
                                    act_type='prelu')
...
def main(args):
    ...
    out = upscaler.do_upscale(img, model_path)

    img_filename = os.path.basename(img_path)
    fname, fext = os.path.splitext(img_filename)
    sr_img_filename = f"{fname}_x4{fext}"
    out.save(os.path.join(args.output_path, sr_img_filename))
